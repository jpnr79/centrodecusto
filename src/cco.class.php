...
if (!class_exists('PluginCentrodecustoApplication')) {
    class PluginCentrodecustoApplication extends CommonDBTM 
    {
        ...
        public function htmlaction(): void
        {
            echo <<<HTML
            ...
            <div class="d-inline-flex search-controls">
                ...
                <div class="d-inline-flex" role="group">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown-export">
                        <li><a class="dropdown-item" href="/glpi/front/report.dynamic.php?item_type=Group&amp;sort%5B0%5D=1&amp;order%5B0%5D=ASC&amp;start=0&amp;criteria%5B0%5D%5Blink%5D=contains&amp;criteria%5B0%5D%5Bvalue%5D=&amp;display_type=2">
